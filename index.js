...
class Car {
  ...
  drive(distance) {
    ...
    this.odometer += distance; //simplified way to write 'this.odometer = this.odometer + distance;'
    this.tank -= (distance / this.milesPerGallon); //simplified way to write this.tank = this.tank - (distance / this.milesPerGallon);
    if (this.tank <= 0) {
